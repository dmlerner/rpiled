...
class PCA(pca.AbstractPCA):
    ...
    def set_brightness(self, channel, milli_percent, relative=False, scale=False, channels=None):
        duty_cycle = pca.to_duty_cycle(milli_percent)
        debug('chan, mp, dc, relative, scale', channel, milli_percent, duty_cycle, relative, scale, channels)
